<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"E:\stuby\PHPTutorial\WWW\8yi/application/admin\view\goods\goodsedit.html";i:1530087646;}*/ ?>
            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data" id="goods-edit-form">
                <fieldset>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="input-xlarge focused" name="goods_name" type="text" value="<?php echo $goodsEdit['goods_name']; ?>"/>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="file-img">
                                ...
                                <div>
                                    <?php if(!(empty($goodsEdit['original_img']) || (($goodsEdit['original_img'] instanceof \think\Collection || $goodsEdit['original_img'] instanceof \think\Paginator ) && $goodsEdit['original_img']->isEmpty()))): ?>
                                        <img src="<?php echo $goodsEdit['original_img']; ?>" alt="点击修改图片" style="max-height: 100%;"/>
                                    <?php else: ?>
                                        <img src="/public/static/common/img/onload.png" alt="点击修改图片" style="max-height: 100%;"/>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <input type="hidden" name="original_img" readonly="readonly" value=""/>
                            <input type="hidden" name="old_original_img" readonly="readonly" value="<?php echo $goodsEdit['original_img']; ?>"/>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select name="cat_id">
                                <?php if(is_array($cate) || $cate instanceof \think\Collection || $cate instanceof \think\Paginator): if( count($cate)==0 ) : echo "" ;else: foreach($cate as $key=>$list): ?>
                                    <option value="<?php echo $list['id']; ?>" <?php if($goodsEdit['cat_id'] == $list['id']): ?>selected="selected"<?php endif; ?> >PC:<?php echo $list['name']; ?>,Mobile:<?php echo $list['mobile_name']; ?></option>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="input-xlarge focused" name="spec" type="text" value="<?php echo $goodsEdit['spec']; ?>" placeholder="500g*1" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">商品单位</label>
                        <div class="controls">
                            <input class="input-xlarge focused" name="company" type="text" value="<?php echo $goodsEdit['company']; ?>" placeholder="瓶" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">市场价格</label>
                        <div class="controls">
                            <input class="input-xlarge focused" name="market_price" type="text" value="<?php echo $goodsEdit['market_price']; ?>" placeholder="3.5" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">淘宝价格</label>
                        <div class="controls">
                            <input class="input-xlarge focused" name="taobao_price" type="text" value="<?php echo $goodsEdit['taobao_price']; ?>" placeholder="3.5" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">华润价格</label>
                        <div class="controls">
                            <input class="input-xlarge focused" name="huarun_price" type="text" value="<?php echo $goodsEdit['huarun_price']; ?>" placeholder="3.5" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">本店价格</label>
                        <div class="controls">
                            <input class="input-xlarge focused" name="shop_price" type="text" value="<?php echo $goodsEdit['shop_price']; ?>" placeholder="2.5" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">排列顺序</label>
                        <div class="controls">
                            <input class="input-xlarge focused" name="sort" type="text" value="<?php echo $goodsEdit['sort']; ?>" placeholder="50" />
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div>
                                ...
                                <input name="is_on_sale" id="yes" type="radio" value="1" <?php if($goodsEdit['is_on_sale'] == 1): ?>checked="checked"<?php endif; ?> />
                            </div>
                            <div>
                                <label for="no">否</label>
                                <input name="is_on_sale" id="no" type="radio" value="0" <?php if($goodsEdit['is_on_sale'] != 1): ?>checked="checked"<?php endif; ?> />
                            </div>
                        </div>
                    </div>
                    <div class="form-actions">
                        <input type="hidden" value="<?php echo $goodsEdit['goods_id']; ?>" name="goods_id" readonly="readonly" />
